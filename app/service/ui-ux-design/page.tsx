...
export default async function UIUXDesignPage() {
  // Ensure a Sanity Service doc exists with slug "ui-ux-design"
  const data = await sanityClient.fetch(serviceBySlugQuery, { slug: "ui-ux-design" });

  if (!data) {
    return (
      <main className="mx-auto max-w-4xl px-6 py-16 space-y-6">
        <h1 className="text-3xl md:text-4xl font-bold">UI/UX Design</h1>
        <p className="text-muted-foreground">
          Content coming soon. Please create/publish the “UI/UX Design” service in Sanity with slug <code>ui-ux-design</code>.
        </p>
      </main>
    );
  }
