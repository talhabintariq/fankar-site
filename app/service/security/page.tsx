...
export default async function SecurityPage() {
  const data = await sanityClient.fetch(serviceBySlugQuery, { slug: "security" });
    ...
    return (
      <main className="mx-auto max-w-4xl px-6 py-16 space-y-6">
        ...
        <p className="text-muted-foreground">
          Content coming soon. Please create/publish the “Security” service in Sanity with slug <code>security</code>.
        </p>
      </main>
    );
  }
